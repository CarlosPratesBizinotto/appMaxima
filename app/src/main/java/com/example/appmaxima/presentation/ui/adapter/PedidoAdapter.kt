...
import com.example.appmaxima.databinding.ItemRecyclerPedidoBinding
    ...
    class ViewHolderPedido(private val binding: ItemRecyclerPedidoBinding) :
        ...
        fun onBind(pedidoResponse: Pedido) {
            binding.apply {
                ...
                validacaoDate(dateNow, date, dataFormatada)
            }
        }

        private fun ItemRecyclerPedidoBinding.validacaoDate(
